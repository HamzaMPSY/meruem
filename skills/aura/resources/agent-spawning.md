...
For `orchestrate:council`, every spawned council reviewer must also include:

```json
{
  "model": "gpt-5.5",
  "execution": "local",
  "personality": "Architect | Skeptic | Pragmatist | Tester | Product thinker",
  "required_output": ["role", "flag", "recommendation", "risks", "reasoning"],
  "allowed_flags": ["green", "yellow", "red"],
